...
const DATA: Artist[] = [
  { id: "1", name: "Ava Martinez", genre: "Singer", location: "Mumbai", price: 12000, imageUrl: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80" },
  { id: "2", name: "DJ Nova", genre: "DJ", location: "Delhi", price: 25000, imageUrl: "https://images.unsplash.com/photo-1511735111819-9a3f7709049c?auto=format&fit=crop&w=1200&q=80" },
  { id: "3", name: "Midnight Echo", genre: "Band", location: "Bangalore", price: 40000, imageUrl: "https://images.unsplash.com/photo-1516280030429-27679b3dc9cf?auto=format&fit=crop&w=1200&q=80" },
  { id: "4", name: "Maya Kapoor", genre: "Dancer", location: "Hyderabad", price: 8000, imageUrl: "https://images.unsplash.com/photo-1541534401786-2077eed87a72?auto=format&fit=crop&w=1200&q=80" },
];
...
export default function Discover() {
  ...
  const filtered = useMemo(() => {
    let out = DATA.filter((a) =>
      ...
      (location === "any" || a.location.toLowerCase() === location.toLowerCase())
    );
    ...
    if (priceRange !== "any") {
      ...
      out = out.filter((a) => (isNaN(min) ? true : a.price >= min) && (isNaN(max) ? true : a.price <= max));
    }
        ...
        <div className="mt-8 rounded-xl border border-border bg-card/60 backdrop-blur p-4 md:p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" className="rounded-full px-5 py-5" onClick={() => setShowFilters((v) => !v)}>
          ...
          {showFilters && (
            <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-5 animate-fade-in-up">
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-wide text-foreground/70">Genre/Skill</div>
              ...
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-wide text-foreground/70">Location</div>
              ...
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-wide text-foreground/70">Availability</div>
                <Input
                  type="date"
                  value={availability}
              ...
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-wide text-foreground/70">Price Range</div>
              ...
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-wide text-foreground/70">Sort By</div>
            ...
            <M.article
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex gap-3">
                  <Button className="flex-1 bg-gradient-to-r from-primary to-accent">Book Now</Button>
